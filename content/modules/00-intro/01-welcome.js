...
<blockquote style="border-left: 3px solid var(--accent); padding-left: 1rem; margin: 1rem 0; color: var(--text-muted); font-style: italic;">
    "Каждый может научиться программировать. Это вопрос времени и практики, не таланта."<br>
            ...
            questions: [
                {
                    ...
                    correct: 0,
                    explanation: 'Программа — это набор точных инструкций, которые компьютер выполняет последовательно. Компьютер делает ровно то, что написано — не больше и не меньше.'
                },
                {
                    id: 'q0001-2',
                    type: 'single',
                    question: 'За какое время реально стать Junior Go-разработчиком с нуля?',
                    options: [
                        '1-2 недели',
                        '6-12 месяцев при регулярной практике',
                        'Минимум 5 лет',
                        'Без профильного образования невозможно'
                    ],
                    correct: 1,
                    explanation: '6-12 месяцев — реалистичный срок для Junior при занятиях 2-3 часа в день. Это подтверждают тысячи историй людей, сменивших профессию через самообучение.'
                }
            ]
        }
    ]
