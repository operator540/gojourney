            ...
            questions: [
                {
                    id: 'q0004-1',
                    type: 'single',
                    question: 'Ты полный новичок в программировании. С чего лучше начать параллельно с GoJourney?',
                    options: [
                        'CS50 от Harvard — бесплатный курс по основам Computer Science',
                        'Купить самую толстую книгу по Go',
                        'Сразу начать писать микросервисы',
                        'Смотреть все YouTube-каналы одновременно'
                    ],
                    correct: 0,
                    explanation: 'CS50 — это лучший бесплатный курс для понимания основ как работает компьютер. Он даёт фундамент под всё остальное. Доступен на cs50.harvard.edu бесплатно.'
                },
                {
                    id: 'q0004-2',
                    type: 'single',
                    question: 'Какая книга по Go лучше всего для абсолютного новичка?',
                    options: [
                        'Concurrency in Go',
                        '100 Go Mistakes',
                    ...
                    correct: 2,
                    explanation: '"Learning Go" Jon Bodner (2021) — лучший выбор для начинающих. Написана понятно, охватывает современный Go, практические примеры.'
                }
            ]
        }
    ]
